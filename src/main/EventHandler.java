...
public class EventHandler {
    ...
    public void checkEvent(){
        ...
        if(canTouchEvent){
            ...
            else if(hit(0,10,39,"any")) {changeMap(1,12,13);}
            else if(hit(1,12,13,"any")) {changeMap(0,10,39);}
            else if(hit(1,12,9,"up")) {speak(gp.npc[1][0]);}
//            else if(hit(23,19,"any")) {damagePit(23,19,gp.dialogueState);}
//            else if(hit(21,16,"left")) {teleport(23,34,gp.dialogueState);}
//            else if(hit(19,36,"any")) {teleport(23,15,gp.dialogueState);}
        }
    ...
    public void healingPool(int gameState){
        if(gp.keyH.enterPressed){
            ...
            gp.playSE(2);
            gp.ui.currentDialogue = "You drink the water. \nYour health and manna have been recovered.";
