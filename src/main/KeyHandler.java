...
public class KeyHandler implements KeyListener {
    ...
    GamePanel gp;
    public boolean upPressed, downPressed, leftPressed, rightPressed, enterPressed, shotKeyPressed, spacePressed, showDebugText;
    // DEBUG
    ...
    public void keyPressed(KeyEvent e) {
        ...
        // TITLE STATE
        if(gp.gameState == gp.titleState) {tileState(code);}
        // PLAY STATE
